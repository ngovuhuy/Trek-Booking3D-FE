       ...
       <div className="login">
            ...
            <div className="text-input relative">
                ...
                <input className='input-text' type={isPassword ? "password" : "text"} placeholder='Password'/>
                 ...
                 <p className='m-0 pt-4 pb-1'>Enter your password</p>
                <input className='input-text' type={isPassword ? "password" : "text"} placeholder='Password'/>
                 <img src="/image/hide.png" className='input-hide cursor-pointer' onClick={togglePasswordVisibility} alt="" />
              ...
              <div className="nav-sign flex justify-between">
                <Link className='pt-2 text-right text-base cursor-pointer text-decoration' style={{color:"#CED1D2"}} href="login">You have a account?</Link>
