...
const formattedDescription = hotelFulDescription.split('.').map((sentence, index) => (
...
useEffect(() => {
 ...
 return (
    <>
      <Modal className='pt-16 ' show={showHotelDetail} onHide={() => handleClosedDetail()} size='lg'>
      ...
      <Modal.Header closeButton>
        ...
        <div className="row">
          <Form.Group className="mb-3 col-6" controlId="tourName">
            <Form.Label className="font-bold text-xl">Hotel Name</Form.Label>
          <p>{hotelName}</p>
          </Form.Group>
          <Form.Group className="mb-3 col-6" controlId="tourTime">
                            <Form.Label className="font-bold text-xl">Hotel Phone</Form.Label>
                            <p>{hotelPhone}</p>
                        </Form.Group>
                        <Form.Group className="mb-3 col-6" controlId="tourTransportation">
            <Form.Label className="font-bold text-xl">Hotel Email</Form.Label>
            <p>{hotelEmail}</p>
          </Form.Group>
          <Form.Group className="mb-3 col-6" controlId="tourPrice">
            <Form.Label className="font-bold text-xl">Hotel District</Form.Label>
            <p>{hotelDistrict}$</p>
          </Form.Group >
          <Form.Group className="mb-3 col-6" controlId="tourAddress">
            <Form.Label className="font-bold text-xl">Hotel City</Form.Label>
            <p>{hotelCity}</p>
            </Form.Group>
            <Form.Group className="mb-3 col-6" controlId="tourCapacity">
            <Form.Label className="font-bold text-xl">Hotel Information</Form.Label>
            <p>{hotelInformation}</p>
          </Form.Group>
          <Form.Group className="mb-3 col-12" controlId="tourDescription">
            <Form.Label className="font-bold text-xl">Hotel Description</Form.Label>
