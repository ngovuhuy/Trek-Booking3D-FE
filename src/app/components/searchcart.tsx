...
<div className="background-img ">
          <div className="text-bg  text-center pt-60">
            ...
            <div className="search-main  p-12 relative">
             ...
             <p className='text-left mb-0 font-bold pb-1'>City, destination, or hotel name</p>
            ...
            <img className='calender-input' src="/image/calendar.png" alt="" />
            ...
            <img className='calender-input-out' src="/image/calendar.png" alt="" />
            <input type="text" className='input-search-in-out'/>
            </div>
             </div>
             <div className="input-text-search pb-4">
             <p className='text-left mb-0 font-bold pb-1'>Guests and Rooms</p>
             <img className='userplus-input' src="/image/userplus.png" alt="" />
              <input type="text" className='input-search'/>
             </div>
