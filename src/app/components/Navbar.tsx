     ...
     <div className="container pt-4 ">
      <div className="nav row pb-3">
        <div className="col-5 text-center ">
          <Link href="/" className='text-blackish no-underline text-2xl lg:mr-44 font-bold '>Trek Booking</Link>
        </div>
      ...
      <img style={{width:"30px",height:"25px"}} src="/image/globe.png" alt="" className='pr-2 '/>
            ...
            <li className='flex hover-bold'>
              ...
              <Link href="cart" className='no-underline text-accent font-bold'>
                Cart(1)
              </Link>
            ...
            <img style={{width:"30px",height:"25px"}} src="/image/bell.png" alt="" className='pr-2'/>
              <a className='no-underline text-accent font-bold' href="">Post your hotel</a>
              </li>
            <li className='flex hover-bold'>
            <img style={{width:"30px",height:"25px"}} src="/image/users.png" alt="" className='pr-2'/>
            <Link className='no-underline text-accent font-bold' href="login">
            Log In/ Sign up
            </Link >
              </li>
          </ul>
       ...
       <ul className='lg:hidden'>
        ...
        <img src="/image/bell.png" alt="" className='pr-2'/>
          <a href="" className='font-bold text-decoration-none text-accent' >Post your hotel</a></li>
        <li className='flex pb-4 hover-bold'>
