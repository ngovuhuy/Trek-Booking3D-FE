...
const ListTourImage = ({ params }: { params: { tourId: string } }) => {
  ...
  const [selectedImageTour, setSelectedImageTour] = useState<ITourImage | null>(null);
...
const currentTourImage = listTourImage.slice(indexOfFirstTourImage, indexOfLastTourImage);
          ...
          <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
            <div className="overflow-x-auto">
              <table className="min-w-full text-start text-sm font-light text-surface dark:text-white border-solid">
                ...
                <tbody>{currentTourImage.length > 0 ? (
                                ...
                                selectedImageTour?.tourId === item.tourId && (
                                  <div className="fixed inset-0 z-10 flex items-center justify-center ">
                                    ...
                                    <div className="relative bg-white p-8 rounded-lg">
                                      <p className="color-black font-bold text-2xl">Do you want to delete Tour Image 3D Id: {item.tourImageId} ?
